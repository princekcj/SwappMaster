...
scheduler.add_job(job3, 'interval', minutes=2)
scheduler.add_job(job4, 'interval', minutes=1)
scheduler.add_job(job44, 'interval', minutes=2)
scheduler.add_job(job5, 'interval', minutes=1)
scheduler.add_job(job6, 'interval', minutes=2)
scheduler.add_job(job7, 'interval', minutes=1)
scheduler.add_job(job8, 'interval', minutes=2)
scheduler.add_job(job9, 'interval', minutes=1)
scheduler.add_job(job10, 'interval', minutes=2)
scheduler.add_job(job11, 'interval', minutes=1)
scheduler.add_job(job12, 'interval', minutes=2)
scheduler.add_job(job13, 'interval', minutes=1)
scheduler.add_job(job14, 'interval', minutes=2)
scheduler.add_job(job15, 'interval', minutes=1)
scheduler.add_job(job16, 'interval', minutes=2)
scheduler.add_job(job17, 'interval', minutes=1)
scheduler.add_job(job18, 'interval', minutes=2)
scheduler.add_job(job19, 'interval', minutes=1)
scheduler.add_job(job20, 'interval', minutes=2)
scheduler.add_job(job21, 'interval', minutes=1)
scheduler.add_job(job22, 'interval', minutes=2)
scheduler.add_job(job23, 'interval', minutes=1)
scheduler.add_job(job24, 'interval', minutes=2)
scheduler.add_job(job25, 'interval', minutes=1)
scheduler.add_job(job26, 'interval', minutes=2)
