...
try:
    ...
    scheduler.add_job(job, 'interval', minutes=120, next_run_time=start_time)
    scheduler.add_job(job4, 'interval', minutes=121, next_run_time=start_time + timedelta(minutes=1))
    scheduler.add_job(job44, 'interval', minutes=122, next_run_time=start_time + timedelta(minutes=2))
    scheduler.add_job(job5, 'interval', minutes=123, next_run_time=start_time + timedelta(minutes=3))
    scheduler.add_job(job6, 'interval', minutes=124, next_run_time=start_time + timedelta(minutes=4))
    scheduler.add_job(job7, 'interval', minutes=125, next_run_time=start_time + timedelta(minutes=5))
    scheduler.add_job(job8, 'interval', minutes=126, next_run_time=start_time + timedelta(minutes=6))
    scheduler.add_job(job9, 'interval', minutes=127, next_run_time=start_time + timedelta(minutes=7))
    scheduler.add_job(job10, 'interval', minutes=128, next_run_time=start_time + timedelta(minutes=8))
    scheduler.add_job(job11, 'interval', minutes=129, next_run_time=start_time + timedelta(minutes=9))
    scheduler.add_job(job12, 'interval', minutes=130, next_run_time=start_time + timedelta(minutes=10))
    scheduler.add_job(job13, 'interval', minutes=131, next_run_time=start_time + timedelta(minutes=11))
    scheduler.add_job(job14, 'interval', minutes=132, next_run_time=start_time + timedelta(minutes=12))
    scheduler.add_job(job15, 'interval', minutes=133, next_run_time=start_time + timedelta(minutes=13))
    scheduler.add_job(job16, 'interval', minutes=134, next_run_time=start_time + timedelta(minutes=14))
    scheduler.add_job(job17, 'interval', minutes=135, next_run_time=start_time + timedelta(minutes=15))
    scheduler.add_job(job18, 'interval', minutes=136, next_run_time=start_time + timedelta(minutes=16))
    scheduler.add_job(job19, 'interval', minutes=137, next_run_time=start_time + timedelta(minutes=17))
    scheduler.add_job(job20, 'interval', minutes=138, next_run_time=start_time + timedelta(minutes=18))
    scheduler.add_job(job21, 'interval', minutes=139, next_run_time=start_time + timedelta(minutes=19))
    scheduler.add_job(job22, 'interval', minutes=140, next_run_time=start_time + timedelta(minutes=20))
    scheduler.add_job(job23, 'interval', minutes=141, next_run_time=start_time + timedelta(minutes=21))
    scheduler.add_job(job24, 'interval', minutes=142, next_run_time=start_time + timedelta(minutes=22))
    scheduler.add_job(job25, 'interval', minutes=143, next_run_time=start_time + timedelta(minutes=23))
    scheduler.add_job(job26, 'interval', minutes=144, next_run_time=start_time + timedelta(minutes=24))
    scheduler.add_job(job2, 'interval', minutes=145, next_run_time=start_time + timedelta(minutes=25))
    scheduler.add_job(job3, 'interval', minutes=146, next_run_time=start_time + timedelta(minutes=26))
    scheduler.add_job(job1, 'interval', minutes=147, next_run_time=start_time + timedelta(minutes=27))
