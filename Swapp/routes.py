...
try:
    ...
    scheduler.add_job(job, 'interval', minutes=360, next_run_time=start_time)
    scheduler.add_job(job4, 'interval', minutes=361, next_run_time=start_time + timedelta(minutes=1))
    scheduler.add_job(job44, 'interval', minutes=362, next_run_time=start_time + timedelta(minutes=2))
    scheduler.add_job(job5, 'interval', minutes=363, next_run_time=start_time + timedelta(minutes=3))
    scheduler.add_job(job6, 'interval', minutes=364, next_run_time=start_time + timedelta(minutes=4))
    scheduler.add_job(job7, 'interval', minutes=365, next_run_time=start_time + timedelta(minutes=5))
    scheduler.add_job(job8, 'interval', minutes=366, next_run_time=start_time + timedelta(minutes=6))
    scheduler.add_job(job9, 'interval', minutes=367, next_run_time=start_time + timedelta(minutes=7))
    scheduler.add_job(job10, 'interval', minutes=368, next_run_time=start_time + timedelta(minutes=8))
    scheduler.add_job(job11, 'interval', minutes=369, next_run_time=start_time + timedelta(minutes=9))
    scheduler.add_job(job12, 'interval', minutes=370, next_run_time=start_time + timedelta(minutes=10))
    scheduler.add_job(job13, 'interval', minutes=371, next_run_time=start_time + timedelta(minutes=11))
    scheduler.add_job(job14, 'interval', minutes=372, next_run_time=start_time + timedelta(minutes=12))
    scheduler.add_job(job15, 'interval', minutes=373, next_run_time=start_time + timedelta(minutes=13))
    scheduler.add_job(job16, 'interval', minutes=374, next_run_time=start_time + timedelta(minutes=14))
    scheduler.add_job(job17, 'interval', minutes=375, next_run_time=start_time + timedelta(minutes=15))
    scheduler.add_job(job18, 'interval', minutes=376, next_run_time=start_time + timedelta(minutes=16))
    scheduler.add_job(job19, 'interval', minutes=377, next_run_time=start_time + timedelta(minutes=17))
    scheduler.add_job(job20, 'interval', minutes=378, next_run_time=start_time + timedelta(minutes=18))
    scheduler.add_job(job21, 'interval', minutes=379, next_run_time=start_time + timedelta(minutes=19))
    scheduler.add_job(job22, 'interval', minutes=380, next_run_time=start_time + timedelta(minutes=20))
    scheduler.add_job(job23, 'interval', minutes=381, next_run_time=start_time + timedelta(minutes=21))
    scheduler.add_job(job24, 'interval', minutes=382, next_run_time=start_time + timedelta(minutes=22))
    scheduler.add_job(job25, 'interval', minutes=383, next_run_time=start_time + timedelta(minutes=23))
    scheduler.add_job(job26, 'interval', minutes=384, next_run_time=start_time + timedelta(minutes=24))
    scheduler.add_job(job2, 'interval', minutes=385, next_run_time=start_time + timedelta(minutes=25))
    scheduler.add_job(job3, 'interval', minutes=386, next_run_time=start_time + timedelta(minutes=26))
    scheduler.add_job(job1, 'interval', minutes=387, next_run_time=start_time + timedelta(minutes=27))
