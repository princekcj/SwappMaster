...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://helloking:|;G(xYgSC[[g'L4V@34.147.129.24/calm?host=/cloudsql/majestic-nimbus-332315:europe-west2:testswapp"
