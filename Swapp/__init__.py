...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql:///calm?host=/cloudsql/majestic-nimbus-332315:europe-west2:testswapp&user=helloking&password=|;G(xYgSC[[g'L4V&sslmode=disable"
